...
export const FX_PROVIDERS: Record<string, FxProvider> = {
  ...
  matsui: {
    ...
    summary: '取引手数料0円の範囲と、別に残るスプレッド、スワップ、受渡決済手数料を分け、1通貨・1,000通貨・1万通貨の円負担へ換算します。',
    minTrade: '1通貨単位',
    costFocus: '取引手数料0円。スプレッド・スワップ・受渡決済手数料を分離',
    caution: '通常の取引手数料は無料ですが、受渡決済を選ぶ場合は通貨別に約定通貨数量×1～20円の手数料がかかります。',
    facts: [
    ...
    checks: ['スプレッド一覧の数量・時間帯', '選択中のレバレッジコース', 'スワップの受取額と支払額', '受渡決済を使う場合の通貨別手数料'],
    sources: [{ label: 'FX手数料', href: 'https://www.matsui.co.jp/fx/fee/' }, { label: 'スプレッド一覧', href: 'https://www.matsui.co.jp/fx/spread/' }, { label: '取引ルール', href: 'https://www.matsui.co.jp/fx/rule/' }, { label: 'リスク・手数料', href: 'https://www.matsui.co.jp/disclaimer/fx.html' }],
  },
  'gmo-click': {
    slug: 'gmo-click',
    name: 'GMOクリック証券 FXネオ',
