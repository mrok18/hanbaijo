    ...
    <div className="fx-page futures-page">
      ...
      <section className="fx-section">
        ...
        <div className="affiliate-grid">
          ...
          <article className="affiliate-card"><div className="affiliate-card-head"><span>COMPARE</span><b>3 ASSETS</b></div><p className="affiliate-category">CROSS-ASSET MARGIN</p><h3>FX・CFD・先物を同じ表で比較</h3><p>取引単位、必要証拠金、1単位の値動き損益、追証と期限を整理します。</p><Link href="/articles/fx-cfd-futures-margin-comparison">比較記事を読む →</Link></article>
