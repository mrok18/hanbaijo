...
export const metadata = {
  ...
  title: '松井証券 取引時間｜米国株プレマーケットと注文条件',
  description: '松井証券の取引時間を、米国株のプレマーケット・通常取引に分けて整理。夏時間17:00〜22:30・冬時間18:00〜23:30の注文条件や注意点を確認できます。',
};

export default function Page() {
  return <article>
    <p className="page-kicker">MATSUI / US STOCK HOURS</p>
    <h1>松井証券 取引時間<br />米国株プレマーケットと注文条件</h1>
    <p className="lede">松井証券の取引時間を、米国株のプレマーケットと通常取引に分けて確認します。夏時間・冬時間の違い、注文条件、通常時間より流動性が低い場合の注意点を整理します。</p>
