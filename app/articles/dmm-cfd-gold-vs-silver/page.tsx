...
export default function Page() {
  return <article>
    ...
    <h1>金と銀を比較<br />1Lot・証拠金・調整額</h1>
    <p className="lede">金と銀はいずれもスポット価格を参照しますが、金は1Lot＝1トロイオンス、銀は1Lot＝10トロイオンスです。同じ1ドルの値動きでも円換算損益は異なります。</p>
