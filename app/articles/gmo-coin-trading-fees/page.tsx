...
export const metadata: Metadata = { alternates: { canonical: '/articles/gmo-coin-trading-fees' }, title: 'GMOコイン 手数料｜販売所・取引所・暗号資産FXを比較', description: 'GMOコインの手数料を、販売所・取引所・暗号資産FX・入出金に分け、無料条件、Maker/Taker、スプレッド、レバレッジ手数料を比較します。' };

export default function Page() { return <article>
  <p className="page-kicker">GMOコイン / FEE GUIDE</p><h1>GMOコイン 手数料<br />販売所・取引所・暗号資産FXを比較</h1>
  <p className="lede">GMOコインの手数料は、提示価格で売買する販売所、板で注文する取引所、証拠金で取引する暗号資産FXで異なります。入出金の無料条件も含め、「手数料無料」だけで決めず、スプレッドやレバレッジのコストまで分けて確認しましょう。</p>
