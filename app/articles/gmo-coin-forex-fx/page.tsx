...
export const metadata: Metadata = { alternates: { canonical: '/articles/gmo-coin-forex-fx' }, title: 'GMOコイン FX｜外国為替FXの1通貨・レバレッジ・スワップ', description: 'GMOコイン FX（外国為替FX）を、1通貨取引、レバレッジ、スワップポイント、証拠金の確認項目で整理します。' };

export default function Page() { return <article>
  <p className="page-kicker">GMOコイン / FX</p><h1>GMOコイン FX｜外国為替FXとは？<br />1通貨からの取引とコスト</h1>
