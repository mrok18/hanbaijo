export const POSTS = [
  ...
  { slug: 'fx-loss-carryforward-filing', category: 'FX・税金', title: 'くりっく365の損失繰越｜3年控除と確定申告の続け方', desc: 'くりっく365の損失繰越の可否、翌年以後3年間の控除、取引しない年も続ける連続申告を整理する。' },
  ...
  { slug: 'fx-profit-under-200k-tax-return', category: 'FX・税金', title: 'FX利益20万円以下なら確定申告は不要？住民税・還付申告の注意', desc: '会社員の所得税申告が不要になる条件と、20万円以下でも別判定の住民税、還付申告、損失繰越を確認する。' },
  ...
  { slug: 'matsui-one-day-margin-cost', category: '国内株・松井証券', title: '松井証券 信用取引の手数料｜一日信用0円と翌日持越し費用', desc: '一日信用の売買0円・金利0％・貸株料0％と、プレミアム空売り料・翌営業日の任意決済手数料を整理する。' },
  ...
  { slug: 'systre-select-365-losscut-margin-shortage', category: 'FX自動売買', title: 'シストレ ロスカット｜セレクト365の基準・発動後の停止', desc: 'シストレセレクト365の有効比率100％以下の全建玉決済、150％のアラート、発動後のストラテジー停止、証拠金不足を整理する。' },
  { slug: 'systre-select-365-vs-otc-fx', category: 'FX自動売買', title: 'シストレセレクト365と店頭FXの違い｜取引所FXを選ぶ意味', desc: 'くりっく365のシストレとは何かを先に答え、価格提示、スワップ、手数料、証拠金から店頭FXとの違いを整理する。' },
  ...
  { slug: 'cfd-price-adjustment', category: 'CFD', title: 'CFD調整額とは？価格・金利・権利調整額の違い', desc: 'CFD調整額の3種類、発生タイミング、受け取り・支払いの違いを計算例と公式資料で整理する。' },
  { slug: 'fx-spread-cost', category: 'FX', title: 'FXの0.2銭は何円？スプレッドを数量別に計算', desc: 'FXの0.2銭を円へ直し、1,000通貨・1万通貨・10万通貨ごとのスプレッド相当額を計算する。' },
