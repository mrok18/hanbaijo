...
export const metadata = {
  title: 'GMOクリック証券の国内株手数料・コスト',
  description: 'GMOクリック証券の国内株現物・信用手数料と、無料対象外、信用金利・貸株料を公式情報から整理します。',
  alternates: { canonical: '/stocks/gmo-click' },
};
export default function Page() { return <StockProviderFactSheet provider={STOCK_PROVIDERS['gmo-click']} relatedArticles={[
  ...
  { href: '/stocks/domestic-fee-comparison', title: '国内株4社の売買手数料を比較', description: 'GMOクリック証券、楽天証券、松井証券、DMM 株を、同日往復と別日売却の条件で比べます。' },
