...
export default async function CryptoPage() {
  ...
  return <div className="content-page">
    ...
    <section aria-labelledby="crypto-next-steps">
      <h2 id="crypto-next-steps">次に見るページ</h2>
      <div className="cta-list">
        <Link href="/articles/hanbaijo-torihikijo">販売所と取引所の違いを読む <span className="go">基本構造を確認 →</span></Link>
        <Link href="/tools/cost-calculator">取引コストを円換算する <span className="go">売買条件を試算 →</span></Link>
        <Link href="/tools/crypto-collateral-ltv-calculator">暗号資産担保ローンのLTVを試算する <span className="go">下落時の余力を確認 →</span></Link>
      </div>
    </section>
