...
export default function Page() {
  return <div className="provider-page fx-provider-page">
    ...
    <section className="provider-section">
      ...
      <div className="provider-directory comparison-guide-directory"><Link href="/articles/tossy-cfd-not-spot"><span>SPOT VS CFD</span><h3>TOSSYは現物取引ではない</h3><p>所有・受渡し・証拠金・コストの違いを整理</p><b>記事を読む →</b></Link><Link href="/articles/dmm-cfd-total-cost"><span>TOTAL COST</span><h3>DMM CFDの総コスト</h3><p>スプレッドと調整額の考え方を確認</p><b>記事を読む →</b></Link></div>
    </section>
