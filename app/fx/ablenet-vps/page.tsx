...
export default function Page() {
  return <div className="provider-page fx-provider-page">
    ...
    <section className="provider-section"><p className="section-index">RELATED</p><h2>VPS費用を取引回数へ配賦する</h2><div className="provider-directory comparison-guide-directory"><Link href="/tools/fx-vps-cost-calculator"><span>CALCULATOR</span><h3>VPS月額・年額計算機</h3><p>本体、RDS、取引回数、自宅PC電気代を入力</p><b>計算する →</b></Link><Link href="/articles/fx-vps-total-cost"><span>TOTAL COST</span><h3>FX自動売買VPSの総コスト</h3><p>更新価格と隠れた固定費を整理</p><b>記事を読む →</b></Link></div></section>
