    ...
    <div className="provider-page">
      ...
      <section className="provider-section">
        ...
        <div className="provider-directory comparison-guide-directory">
          ...
          <Link href="/articles/fxtf-mt5-btc-jpy-vs-usd"><span>MT5 / BTC PAIRS</span><h3>BTC/JPYとBTC/USDを比較</h3><p>証拠金に使う円換算レートの違い</p><b>記事を読む →</b></Link>
          <Link href="/articles/fxtf-mt5-gold-cfd-margin"><span>MT5 / GOLD CFD</span><h3>金1Lotの必要資金を計算</h3><p>ドル円換算、手数料、スワップ</p><b>記事を読む →</b></Link>
          <Link href="/articles/fxtf-mt5-silver-cfd-margin"><span>MT5 / SILVER CFD</span><h3>銀1Lotの必要資金を計算</h3><p>10トロイオンスと新規コスト</p><b>記事を読む →</b></Link>
