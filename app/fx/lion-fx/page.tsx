...
export default function Page() { return <FxProviderFactSheet provider={FX_PROVIDERS['lion-fx']} affiliateOffer={AFFILIATE_OFFERS['hirose-fx-accesstrade']} relatedArticles={[
