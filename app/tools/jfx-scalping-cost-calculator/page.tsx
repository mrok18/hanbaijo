...
export default function Page() {
  ...
  return <div className="calculator-page">
    ...
    <nav className="calculator-proof" aria-label="計算根拠と関連記事"><Link href="/articles/jfx-scalping-spread-cost">JFX短期売買コスト解説</Link><Link href="/fx/jfx">JFX取引条件一覧</Link><Link href="/tools/fx-pip-value-calculator">pips損益計算</Link><a href="https://www.jfx.co.jp/trading_rule/spread/" target="_blank" rel="noopener noreferrer">JFX公式スプレッド</a></nav>
  </div>;
}
