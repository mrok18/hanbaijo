...
export default function Page() {
  ...
  return <div className="calculator-page">
    ...
    <nav className="calculator-proof" aria-label="計算根拠と関連記事"><Link href="/articles/nikkei225-micro-profit-loss">マイクロの損益早見表</Link><Link href="/articles/matsui-futures-normal-vs-day">通常・一日先物の料金比較</Link><Link href="/articles/futures-tick-value">1ティックの計算方法</Link><Link href="/futures/nikkei225-fee-comparison">証券会社別手数料</Link><a href="https://www.matsui.co.jp/fee/" target="_blank" rel="noopener noreferrer">松井証券の公式料金表</a></nav>
