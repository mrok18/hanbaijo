...
export default function Page() {
  return <div className="calculator-page">
    ...
    <nav className="calculator-proof" aria-label="計算根拠と関連記事"><Link href="/articles/futures-margin">証拠金の仕組み</Link><Link href="/articles/nikkei225-micro-profit-loss">マイクロの損益早見表</Link><Link href="/articles/futures-tick-value">1ティックの計算方法</Link><Link href="/tools/matsui-futures-cost-calculator">手数料込み損益計算</Link><Link href="/futures/nikkei225-fee-comparison">証券会社別手数料</Link></nav>
