...
export default function Page() {
  ...
  return <div className="calculator-page">
    ...
    <nav className="calculator-proof" aria-label="関連記事"><Link href="/articles/us-stock-profit-yen-appreciation">株高でも円換算で損する条件</Link><Link href="/articles/us-stock-fx-cost">米国株の為替コスト計算</Link><Link href="/articles/matsui-us-stock-fx-fee">松井証券の為替手数料</Link><Link href="/tools/matsui-us-stock-cost-calculator">松井証券専用計算機</Link><Link href="/articles/dmm-kabu-us-stock-fee">DMM 株の米国株手数料</Link></nav>
