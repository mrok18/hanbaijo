...
export default function Page() {
  ...
  return <div className="calculator-page">
    ...
    <section className="calculator-explain" aria-labelledby="fx-simulation-example"><p className="section-index">EXAMPLE / FX SIMULATION</p><h2 id="fx-simulation-example">入力例：30万円の口座で1％を許容する場合</h2><p>口座資金30万円、許容リスク1％、損切り50pips、スプレッド0.2pips、1通貨・1pips＝0.01円、1,000通貨刻みで入力すると、許容損失額は3,000円、計算上の最大数量は5,000通貨、想定損失は約2,510円です。</p><div className="formula-box"><code>3,000円 ÷（50＋0.2）pips ÷ 0.01円 ≒ 5,976通貨 → 5,000通貨</code><small>実際の取引単位・提示スプレッド・約定価格を優先する仮定試算</small></div></section>
    ...
    <section className="article-sources" aria-labelledby="fx-simulation-sources"><h2 id="fx-simulation-sources">計算条件を確認する公式資料</h2><ul><li><a href="https://www.fsa.go.jp/ordinary/iwagai/" target="_blank" rel="noopener noreferrer">金融庁「外国為替証拠金取引について」</a></li><li><a href="https://www.matsui.co.jp/fx/margin-sim/" target="_blank" rel="noopener noreferrer">松井証券「証拠金シミュレーション」</a></li></ul><p>計算例と参照先は2026年9月19日に確認しました。取引単位、スプレッド、必要証拠金、約定条件は会社や通貨ペアで異なるため、発注前に公式画面を優先してください。</p></section>
  </div>;
}
