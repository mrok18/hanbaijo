...
export default function Page() {
  ...
  return <div className="calculator-page">
    ...
    <nav className="calculator-proof" aria-label="関連ツール"><Link href="/tools/fx-pip-value-calculator">1pipsの円損益を計算</Link><Link href="/tools/fx-position-size-calculator">許容損失から数量を逆算</Link><Link href="/tools/cost-calculator">往復コストを計算</Link><Link href="/articles/fx-position-size-calculation">取引数量の決め方</Link></nav>
