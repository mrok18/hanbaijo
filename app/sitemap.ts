...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    ...['fx', 'cfd', 'stocks', 'futures', 'markets', 'tools/cost-calculator', 'tools/cfd-margin-calculator', 'tools/matsui-us-stock-cost-calculator', 'tools/matsui-futures-cost-calculator', 'tools/matsui-box-rate-calculator', 'articles', 'method', 'about', 'disclaimer', 'contact'].map((p) => ({
